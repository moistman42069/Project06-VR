...
unsigned=OUT/'p06-quest-0.1.3-unsigned.apk'
...
aligned=OUT/'p06-quest-0.1.3-aligned.apk'
...
(OUT/'p06-quest-0.1.3-receipt.json').write_text(json.dumps(receipt,indent=2),encoding='utf-8')
